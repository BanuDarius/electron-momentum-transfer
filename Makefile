...
MAIN_SRCS = $(SRC_DIR)/laser_electron.c $(SRC_DIR)/error_calc.c $(SRC_DIR)/conv_calc.c $(SRC_DIR)/find_enter_exit_time.c $(SRC_DIR)/find_final_p.c $(SRC_DIR)/find_max_p.c
