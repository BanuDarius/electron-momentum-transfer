...
void simulate(FILE *out, struct particle *e, struct laser *l, double *out_chunk, int output_mode, int num, int steps, int substeps, double dtau, int core_num, void (*compute_function)(double *, double *, struct laser *)) {
...
int main(int argc, char **argv) {
	...
	int mode = atoi(argv[1]), output_mode = atoi(argv[2]), substeps = atoi(argv[9]), core_num = atoi(argv[11]);
	...
	double *out_chunk = create_out_chunk(output_mode, num, steps, substeps, core_num);
	...
	simulate(out, e, l, out_chunk, output_mode, num, steps, substeps, dtau, core_num, compute_function);
