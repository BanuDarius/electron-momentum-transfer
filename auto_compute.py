...
if __name__ == "__main__":
    ...
    for i in range(0, sweep_steps):
        ...
        programs.run_simulation("electromagnetic", all_states, a0, xif, tauf, wave_count, num_phase, steps_electromag, substeps_electromag)
        
        programs.find_final_py("electromagnetic", num_phase, steps_electromag_final)
        
        programs.find_enter_exit_time(num_phase, steps_electromag_final)
        ...
        programs.run_simulation("ponderomotive", all_states, a0, xif, tauf, wave_count, num_phase, steps_pond, substeps_pond)
        
        programs.find_final_py("ponderomotive", num_phase, steps_pond_final)
        
        programs.find_enter_exit_time(num_phase, steps_pond_final)
    ...
    plots.plot_2d_heatmap_all("ponderomotive", a0_array, sweep_steps, num_phase, wave_count)
